...
class ContainerProfileSettings(BaseModel):
    ...
    internal_port: Optional[List[int]] = None
    ctrl_port_range: Optional[List[Tuple[int, int]]] = None
    data_port_range: Optional[List[Tuple[int, int]]] = None
    serv_port_range: Optional[List[Tuple[int, int]]] = None
